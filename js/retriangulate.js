    ...
    export function retriangulate(P, F, opts = {}) {
      ...
      for (const [, fs] of em) {
        ...
        const before = Math.min(
          triMinAngle(P, u, v, w1),
          triMinAngle(P, v, u, w2)
        );
        const after = Math.min(
          triMinAngle(P, u, w2, w1),
          triMinAngle(P, v, w1, w2)
        );
        ...
        newF[fa] = [u, w2, w1];
        newF[fb] = [v, w1, w2];
        lockedFace.add(fa); lockedFace.add(fb);
